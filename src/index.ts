...
const PACK_LABEL = 'Business Feeds';
...
const FEEDS: Record<string, FeedDef> = {
  ...
  noahpinion: { title: "Noahpinion", url: "https://www.noahpinion.blog/feed", category: "economics", source: "Noahpinion", description: "Economics & policy (Noah Smith)." },
  'search-engine-land': { title: "Search Engine Land", url: "https://searchengineland.com/feed", category: "marketing", source: "Search Engine Land", description: "SEO & search marketing." },
  curbed: { title: "Curbed", url: "https://www.curbed.com/rss/index.xml", category: "real-estate", source: "Curbed", description: "Cities & real estate." },
  'morning-brew': { title: "Morning Brew", url: "https://www.morningbrew.com/feed", category: "business", source: "Morning Brew", description: "Business news newsletter." },
};
